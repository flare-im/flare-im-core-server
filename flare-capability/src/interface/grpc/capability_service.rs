...
use flare_grpc_proto::capability::{
    ...
    DispatchCapabilityRequest, DispatchCapabilityResponse, GrantUserCapabilityRequest,
    GrantUserCapabilityResponse, ListCapabilitiesRequest, ListCapabilitiesResponse,
    ListUserCapabilitiesRequest, ListUserCapabilitiesResponse, RevokeUserCapabilityRequest,
...
use crate::application::capability::{dispatch_capability_command, list_registered_capabilities};
use crate::domain::capability::{CapabilityDispatchCommand, CapabilityPolicyBackend};
use crate::infrastructure::capability::{CapabilityExtensionRegistry, DispatchRateLimiter};
...
/// Capability gRPC 服务（注册表 + 策略 + 生产护栏）
