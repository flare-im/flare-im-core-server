...
use crate::interface::grpc::{
    CapabilityGrpcServer, HookServiceServer, ImHookPluginServer,
};
...
pub struct ApplicationContext {
    ...
    /// 已连接的 **flare-strom-sfu** 控制面（仅 `FLARE_CAPABILITY_RTC_BACKEND=strom` 时存在）。
    pub strom_sfu_rtc: Option<Arc<crate::infrastructure::capability::StromSfuGrpcRtcCapability>>,
