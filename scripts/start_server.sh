...
# 9. 媒资服务：media（媒资服务）
# 10. API 网关：api-gateway（业务系统统一入口）
...
for service in "${CORE_SERVICES[@]}"; do
    ...
    case "$service" in
        ...
        "api-gateway")
            ...
            export FLARE_API_GATEWAY_GRPC_MESSAGE_INGEST_STATIC_FALLBACK="${FLARE_API_GATEWAY_GRPC_MESSAGE_INGEST_STATIC_FALLBACK:-http://127.0.0.1:${MESSAGE_INGEST_PORT}}"
            export FLARE_API_GATEWAY_GRPC_MESSAGE_ORCHESTRATOR_STATIC_FALLBACK="${FLARE_API_GATEWAY_GRPC_MESSAGE_ORCHESTRATOR_STATIC_FALLBACK:-http://127.0.0.1:${MESSAGE_ORCH_PORT}}"
            export FLARE_API_GATEWAY_GRPC_CONVERSATION_STATIC_FALLBACK="${FLARE_API_GATEWAY_GRPC_CONVERSATION_STATIC_FALLBACK:-http://127.0.0.1:${CONVERSATION_PORT}}"
            export FLARE_API_GATEWAY_GRPC_MEDIA_STATIC_FALLBACK="${FLARE_API_GATEWAY_GRPC_MEDIA_STATIC_FALLBACK:-http://127.0.0.1:${MEDIA_PORT}}"
            ENV_VARS="set"
            ;;
        *)
    ...
    env_args=(
        ...
        "FLARE_API_GATEWAY_TOKEN_SECRET=$FLARE_API_GATEWAY_TOKEN_SECRET"
    ...
    [ -n "${FLARE_API_GATEWAY_GRPC_MESSAGE_INGEST_STATIC_FALLBACK:-}" ] && env_args+=("FLARE_API_GATEWAY_GRPC_MESSAGE_INGEST_STATIC_FALLBACK=$FLARE_API_GATEWAY_GRPC_MESSAGE_INGEST_STATIC_FALLBACK")
    [ -n "${FLARE_API_GATEWAY_GRPC_MESSAGE_ORCHESTRATOR_STATIC_FALLBACK:-}" ] && env_args+=("FLARE_API_GATEWAY_GRPC_MESSAGE_ORCHESTRATOR_STATIC_FALLBACK=$FLARE_API_GATEWAY_GRPC_MESSAGE_ORCHESTRATOR_STATIC_FALLBACK")
    [ -n "${FLARE_API_GATEWAY_GRPC_CONVERSATION_STATIC_FALLBACK:-}" ] && env_args+=("FLARE_API_GATEWAY_GRPC_CONVERSATION_STATIC_FALLBACK=$FLARE_API_GATEWAY_GRPC_CONVERSATION_STATIC_FALLBACK")
    [ -n "${FLARE_API_GATEWAY_GRPC_MEDIA_STATIC_FALLBACK:-}" ] && env_args+=("FLARE_API_GATEWAY_GRPC_MEDIA_STATIC_FALLBACK=$FLARE_API_GATEWAY_GRPC_MEDIA_STATIC_FALLBACK")
    ...
    if [ "$service" = "signaling-online" ]; then
        ...
        unset FLARE_API_GATEWAY_GRPC_MESSAGE_INGEST_STATIC_FALLBACK FLARE_API_GATEWAY_GRPC_MESSAGE_ORCHESTRATOR_STATIC_FALLBACK FLARE_API_GATEWAY_GRPC_CONVERSATION_STATIC_FALLBACK FLARE_API_GATEWAY_GRPC_MEDIA_STATIC_FALLBACK
    fi
