...
└────────────────────┬────────────────────────────────────┘
                     │
┌────────────────────▼────────────────────────────────────┐
│      flare-im-service-kit::discovery (运行时封装)          │
│  ┌────────────────────────────────────────────────────┐  │
│  │  从 base.toml 读取配置                               │  │
...
```rust
use flare_im_service_kit::discovery::init_from_app_config;
...
use std::net::SocketAddr;
use flare_im_service_kit::discovery::init_from_app_config;
use flare_im_service_kit::{ServiceDiscover, ServiceDiscoverUpdater, ServiceRegistry};
...
```rust
use flare_im_service_kit::discovery::init_from_registry_config;
use flare_im_service_kit::RegistryConfig;
use std::net::SocketAddr;
