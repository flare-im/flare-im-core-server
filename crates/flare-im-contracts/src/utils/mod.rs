//! 工具函数模块
//!
//! 提供时间戳转换、时间线提取、seq 操作、未读数计算、字符串/上下文等纯工具。
...
/// # 示例
/// ```
/// use flare_im_contracts::utils::embed_seq_in_message;
/// use flare_proto::common::Message;
///
/// let mut message = Message::default();
...
/// ```
/// use std::collections::HashMap;
/// use flare_im_contracts::utils::extract_seq_from_extra;
///
...
/// ```
/// use std::collections::HashMap;
/// use flare_im_contracts::utils::embed_seq_in_extra;
///
/// let mut extra = HashMap::new();
