...
use crate::interface::messaging::ack_request_consumer::PushAckRequestHandler;
use crate::interface::messaging::custom_request_consumer::PushCustomRequestHandler;
use crate::interface::messaging::event_request_consumer::PushEventRequestHandler;
use crate::interface::messaging::message_request_consumer::PushMessageRequestHandler;
use crate::interface::messaging::notification_request_consumer::PushNotificationRequestHandler;
...
pub async fn initialize(
    ...
    Dispatcher::register(&mut dispatcher, config.push_message_topic.clone(), message_adapter)?;
    ...
    Dispatcher::register(&mut dispatcher, config.push_event_topic.clone(), event_adapter)?;
    ...
    Dispatcher::register(&mut dispatcher, config.push_custom_topic.clone(), custom_adapter)?;
